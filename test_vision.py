...
# 设置 ffmpeg 可执行文件路径
os.environ["IMAGEIO_FFMPEG_EXE"] = "/opt/homebrew/Cellar/ffmpeg"  # 根据你的实际路径进行设置
...
# 训练多层感知机模型
model = MLPRegressor(hidden_layer_sizes=(10, 10), max_iter=100)
...
# 在真实环境中评估训练好的策略并保存视频
def evaluate_real_env(env, individual, video_folder):
    env = gym.w
